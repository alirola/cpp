...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/31 20:33:24 by alirola-          #+#    #+#             */
/*   Updated: 2024/08/27 14:33:48 by alirola-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Phonebook::search_contact()
{
	...
	for (int i = 0; i < index; i++)
	{
		std::cout << "|          |          |          |          |\n";
		std::cout << "|         " << i + 1 << "|";
		this->contacts[i].printstr(1);
		this->contacts[i].printstr(2);
		this->contacts[i].printstr(3);
		std::cout << "\n";
		std::cout << "|__________|__________|__________|__________|\n";
	}
	std::cout << "\n";
